...
'''
follow-up to 7.1.:
maps elements in different form versions (as reconstructed by 7.1) to patients based on patient mappins.

Outputs the expected element list required for Completeness
'''
